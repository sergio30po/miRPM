...
The current release is `miRPM` 0.2.0. The API retains compatibility
with the original 0.1.0 interfaces where practical, while new code
should use the named arguments documented in the current function
references.
