...
|----|----|
| [`normalize_rpm()`](reference/normalize_rpm.md) | Performs RPM normalization on a count matrix. |
| [`filter_mirnas()`](reference/filter_mirnas.md) | Removes low-abundance miRNAs based on count thresholds. |
| [`miRNA_expression_plot()`](reference/miRNA_expression_plot.md) | Visualizes normalized miRNA expression distributions. |
| [`individual_miRNA_plot()`](reference/individual_miRNA_plot.md) | Displays the expression pattern of a single miRNA across conditions. |
| [`perform_statistical_tests()`](reference/perform_statistical_tests.md) | Conducts non-parametric statistical tests (e.g., Kruskal–Wallis, Dunn). |
...
page](https://sergio30po.github.io/miRPM) for detailed function
references.
