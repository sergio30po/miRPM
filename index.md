...
edgeR or limma-voom, particularly when composition bias, complex designs
or strong mean-variance relationships are expected.
...
| Function | Purpose |
|----|----|
| [`normalize_rpm()`](https://sergio30po.github.io/miRPM/reference/normalize_rpm.md) | Normalize a complete count matrix using column sums or externally supplied library sizes. |
| [`filter_mirnas()`](https://sergio30po.github.io/miRPM/reference/filter_mirnas.md) | Filter miRNAs by RPM abundance, raw-count support, prevalence and group-specific criteria. |
| [`perform_statistical_tests()`](https://sergio30po.github.io/miRPM/reference/perform_statistical_tests.md) | Run Mann-Whitney-Wilcoxon or Kruskal-Wallis/Dunn analyses with FDR correction and effect sizes. |
| [`miRNA_expression_plot()`](https://sergio30po.github.io/miRPM/reference/miRNA_expression_plot.md) | Create a joint static and interactive expression plot for selected miRNAs. |
| [`individual_miRNA_plot()`](https://sergio30po.github.io/miRPM/reference/individual_miRNA_plot.md) | Create one static expression plot per selected miRNA, with optional PNG export. |
...
uses the complete column sums of the input matrix as library sizes.
...
The example below retains miRNAs reaching at least 5 RPM in at least 50%
of samples from any group. A minimum raw-count criterion is also
applied.
...
uses the Mann-Whitney-Wilcoxon rank-sum test.
